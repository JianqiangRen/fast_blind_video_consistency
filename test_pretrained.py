...
if __name__ == "__main__":
    ...
    for v in range(len(video_list)):
        ...
        ## frame 0
        frame_p1 = utils.read_img(os.path.join(process_dir, "frame_00000_hr_sr.png"))
        output_filename = os.path.join(output_dir, "frame_00000.png")
        ...
        for t in range(1, len(frame_list)):
            ...
            ### load frames
            frame_i1 = utils.read_img(os.path.join(input_dir, "frame_%05d.png" %(t - 1)))
            frame_i2 = utils.read_img(os.path.join(input_dir, "frame_%05d.png" %(t)))
            frame_o1 = utils.read_img(os.path.join(output_dir, "frame_%05d.png" %(t - 1)))
            frame_p2 = utils.read_img(os.path.join(process_dir, "frame_%05d_hr_sr.png" %(t)))
            ...
            ### save output frame
            output_filename = os.path.join(output_dir, "frame_%05d.png" %(t))
